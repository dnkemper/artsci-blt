...
class SettingsTest extends TestCase {
  ...
  public function testFileIsCreated(): void {
    ...
    $this->assertTrue($this->fileSystem->exists($this->drupalRoot . '/web/sites/settings/default.global.settings.php'));
    // Assert that settings.php file exist.
    $this->assertTrue($this->fileSystem->exists($this->drupalRoot . '/web/sites/default/settings.php'));
 ...
 */
';
    $this->assertEquals($content, file_get_contents($this->drupalRoot . '/web/sites/default/settings.php'));
    // Assert that default.includes.settings.php file exist.
    $this->assertTrue($this->fileSystem->exists($this->drupalRoot . '/web/sites/default/settings/default.includes.settings.php'));
    // Assert that default.local.settings.php file exist.
    $this->assertTrue($this->fileSystem->exists($this->drupalRoot . '/web/sites/default/settings/default.local.settings.php'));
    // Assert that local.settings.php file exist.
    $this->assertTrue($this->fileSystem->exists($this->drupalRoot . '/web/sites/default/settings/local.settings.php'));
    // Get the local.settings.php file content.
    $localSettings = file_get_contents($this->drupalRoot . '/web/sites/default/settings/local.settings.php');
